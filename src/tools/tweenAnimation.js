...
// tweenAnimation(元素,样式,初始值,目标值,持续时间,间隔时间,tween函数)

export default function tweenAnimation(el, style, init, target, time, interval, type, callback) {
    ...
    clearInterval(el.timers[style]);

    if (c === 0) return;
    
    el.timers[style] = setInterval(function () {
